            ...
            <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div className="flex min-h-full items-end justify-end p-4 text-center sm:items-center sm:p-0">
                    <div className="p-10 relative transform overflow-hidden  bg-white text-left h-screen shadow-xl transition-all sm:w-4/12 sm:max-w-lg">
                        <h1 className='text-2xl cursor-pointer' onClick={() => setLogin(false)}>x</h1>
                        <div className='flex'>
                            <div>
                                <button className='font-semibold text-3xl mt-3'>Login</button>
                        ...
                        <h1 className='text-xs font-medium mt-2'>By clicking on login , I accept the Terms & <br /> Privacy Policy</h1>
                    </div>
                </div>
            </div>
        </div>
